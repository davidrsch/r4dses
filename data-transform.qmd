...
Por ejemplo, podríamos filtrar los vuelos que salieron más o menos a tiempo y luego organizar los resultados para ver qué vuelos se retrasaron más al llegar:
...
```{r}
#| fig-alt: >
#|   Un diagrama de dispersión que muestra el número de vuelos frente a la demora promedio en la llegada. Retrasos
...
La forma de este gráfico es muy característica: cada vez que traza una media (u otras estadísticas resumidas) frente al tamaño del grupo, verá que la variación disminuye a medida que aumenta el tamaño de la muestra[^data-transform-4].

[^data-transform-4]: \*tos\* la ley de los grandes números \*tos\*.
...
#| warning: false
#| fig-alt: >
#|   Diagrama de dispersión del número de vuelos de un avión dado frente al retraso promedio
#|   para esos vuelos, para aviones con más de 25 vuelos. Como retraso promedio
#|   aumenta de -20 a 10, el número de vuelos también aumenta. Para
#|   mayores demoras promedio, el número de vuelos disminuye.
...
El siguiente código utiliza datos del paquete **Lahman** para comparar la proporción de veces que un jugador acierta frente a la cantidad de veces que intenta poner la pelota en juego:
