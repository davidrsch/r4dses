...
@fig-flights-dist-daily superpone un polígono de frecuencia para cada día.
...
#| fig-cap: >
#|   365 polígonos de frecuencia de `dep_delay`, uno para cada día. La frecuencia
#|   los polígonos parecen tener la misma forma, lo que sugiere que es razonable
#|   para comparar días mirando solo algunas estadísticas resumidas.
#| fig-alt: >
#|   La distribución de `dep_delay` está muy sesgada a la derecha con un fuerte
#|   pico ligeramente inferior a 0. Los 365 polígonos de frecuencia son en su mayoría
#|   superpuestas formando una espesa capa negra insulsa.
flights |>
  filter(dep_delay < 120) |> 
