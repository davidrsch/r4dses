...
En el próximo capítulo, profundizaremos en algunos de los detalles de las estructuras de datos vectoriales de R que hemos omitido hasta ahora.
Estos no son inmediatamente útiles por sí mismos, pero son una base necesaria para el siguiente capítulo sobre iteración que le brinda más herramientas para reducir la duplicación de código.
