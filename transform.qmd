...
-   @sec-logicals te enseña sobre vectores lógicos.
    ...
    Aprenderá cómo crearlos con comparaciones numéricas, cómo combinarlos con álgebra booleana, cómo usarlos en resúmenes y cómo usarlos para transformaciones de condiciones.
