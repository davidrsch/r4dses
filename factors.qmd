...
-   Opcionalmente, `fun`, una función que se usa si hay varios valores de `x` para cada valor de `f`. El valor predeterminado es `mediana`.
...
Por ejemplo, toma `gss_cat$partyid`:
