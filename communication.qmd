...
Hiciste cada trama con un propósito, podías mirarla rápidamente y luego pasar a la siguiente trama.
En el curso de la mayoría de los análisis, producirá decenas o cientos de tramas, la mayoría de las cuales se desechan de inmediato.
...
Este ejemplo agrega un título de trama:
...
#|   el tamaño del motor de los automóviles está superpuesto. La trama se titula "Eficiencia de combustible
...
Evite títulos que solo describan cuál es la trama, por ejemplo "Un diagrama de dispersión de la cilindrada del motor frente a la economía de combustible".
