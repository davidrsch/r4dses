...
Por ejemplo, si está creando múltiples variables en `mutate()`, es posible que desee agregar espacios para que todos los `=` se alineen.
...
Esto hace que sea más fácil agregar nuevos pasos, reorganizar pasos existentes, modificar elementos dentro de un paso y obtener una vista general leyendo los verbos en el lado izquierdo.
...
Siempre que pueda dar a algo un nombre informativo, debe darle un nombre informativo.
