...
Los vectores lógicos son el tipo de vector más simple porque cada elemento solo puede tener uno de tres valores posibles: verdadero, `TRUE`, falso, `FALSE` y faltante, `NA`.
...
Pero si los prueba para la igualdad, obtiene falso, `FALSE`:
...
`is.na(x)` funciona con cualquier tipo de vector y devuelve verdadero, `TRUE`, para los valores faltantes y falso, `FALSE`, para todo lo demás:
