...
Un **diagrama de caja** es un tipo de abreviatura visual para medidas de posición (percentiles) que describen una distribución que se usa comúnmente en el análisis estadístico de datos.
...
7.  Cree los dos diagramas de barras segmentadas siguientes.
