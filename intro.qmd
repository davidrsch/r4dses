...
Este libro se enfoca con orgullo en pequeños conjuntos de datos en memoria.
Este es el lugar correcto para comenzar porque no puede abordar big data a menos que tenga experiencia con small data.
Las herramientas que aprende en este libro manejarán fácilmente cientos de megabytes de datos y, con un poco de cuidado, normalmente puede usarlas para trabajar con 1-2 Gb de datos.
Si trabaja habitualmente con datos más grandes (10-100 Gb, digamos), debe obtener más información sobre [data.table](https://github.com/Rdatatable/data.table).
...
Esta flexibilidad tiene sus desventajas, pero la gran ventaja es lo fácil que es desarrollar gramáticas personalizadas para partes específicas del proceso de ciencia de datos.
