...
Por ejemplo, podríamos usar `all()` y `any()` para averiguar si cada vuelo se retrasó menos de una hora o si algún vuelo se retrasó más de 5 horas.
...
Eso, por ejemplo, nos permite ver la proporción de vuelos que se retrasaron menos de 60 minutos y la cantidad de vuelos que se retrasaron más de 5 horas:
