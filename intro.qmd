...
Las herramientas que aprende en la mayoría de este libro manejarán fácilmente cientos de megabytes de datos y, con un poco de cuidado, normalmente puede usarlas para trabajar con unos pocos gigabytes de datos.
...
Por ejemplo, usamos los siguientes paquetes para proporcionar conjuntos de datos interesantes:
