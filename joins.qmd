...
Cuando se necesita más de una variable, la llave se denomina **Llave compuesta.** Por ejemplo, en nycflights13:
...
Es especial porque la salida siempre tendrá las mismas filas que `x`, el dataframe al que estas uniendo[^joins-2].
...
Y para cada empleado queremos encontrar la fecha de la última fiesta que viene antes (o en) su cumpleaños.
