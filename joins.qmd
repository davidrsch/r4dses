...
### Filtrado de uniones {#sec-non-equi-joins}
...
#| fig-cap: >
#|   Una combinación izquierda que muestra las teclas `x` e `y` en la salida.
#| fig-alt: >
...
#| out-width: ~
#| fig-cap: >
#|   Una siguiente combinación es similar a una combinación de desigualdad mayor 
