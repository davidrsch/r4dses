...
-   `position = "dodge"` coloca objetos superpuestos directamente *al lado* uno del otro.
    ...
    #| fig-height: 2
    #| fig-alt: >
    #|   A la izquierda, gráfico de barras segmentadas de corte de diamantes, donde cada barra se rellena con
    ...
    #|   A la derecha, gráfico de barras esquivado de corte de diamantes. Las barras multiples se agrupan por niveles
