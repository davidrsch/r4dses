...
Entre estos capítulos se encuentran otros cinco capítulos que se centran en su flujo de trabajo de R.
En @sec-workflow-basics, @sec-workflow-pipes, @sec-workflow-style y @sec-workflow-scripts-projects aprenderá buenas prácticas de flujo de trabajo para escribir y organizar su código de R.
...
Finalmente, @sec-workflow-getting-help le enseñará cómo obtener ayuda para seguir aprendiendo.
